...
- **Cartonașe printabile** (`/print`) — trei planșe A4 cu coduri QR către
  ...
  fețe), planșa 2 (2 coduri — doar se îndoaie → un cartonaș mare) și planșa 3
  (A4 pe orizontal, 2 coduri — se îndoaie pe verticală → un cartonaș cu două
  fețe A5 care stă în picioare ca o carte deschisă). La planșele 1–2 jumătățile
